...
class BottomPanel extends _react.Component {
  constructor(props) {
    ...
    _defineProperty(this, "onDrawerSnap", snap => {
      ...
      } else if (snapPoints[snap.nativeEvent.index] === snapPoints[snapPoints.length - 1]) {
    ...
    this._deltaY = new _reactNativeReanimated.default.Value(500);
    this.state = {
      snapToIndex: 0,
      points: 100,
    ...
    this.sheetRef = /*#__PURE__*/_react.default.createRef();
  }
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(_reactNative.View, {
      ...
      style: [styles.panelContainer, !backDropTransparent && {
      ...
      style: renderTip && [isModal ? styles.modal : styles.panel, {
    ...
    }, !isModal && isRoundBorderWithTipHeader && renderTip && /*#__PURE__*/_react.default.createElement(_reactNative.View, {
